...
export default function About() {
  ...
  const longText = `A <b>Full-Stack Developer</b> who is passionate about web development and eager to tackle challenges. Specializing in <b>React</b>, <b>Typescript</b>, and <b>Node.js</b> I am open to new technologies and aspire to become a great <b>Software Engineer</b>. I prioritize optimal coding practices and embrace diverse ideas to drive innovation and excellence in my career.`;
